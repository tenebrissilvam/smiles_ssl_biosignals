...
from ecg_data_feature_extraction_for_predict_v3 import *
...
from models_feature_extraction_v3 import load_encoder
from timm.scheduler import CosineLRScheduler
from torch.utils.data import DataLoader


def parse(args_list=None):
    ...
    parser.add_argument(
        "--ckpt_dir",
        default="/home/jupyter/datasphere/project/egor_data_feature_extraction/weights/ecg_jepa_20250725_031756_[0.175, 0.225]_feature_extraction/epoch10.pth",
        type=str,
        metavar="PATH",
    ...
    parser.add_argument(
        "--output_dir",
        default="C:/Users/padin/Desktop/Scoltech/BIOSIGNALS/2410.08559v4/ECG_JEPA-master/ECG_JEPA-master/downstream_tasks/output/linear_eval/",
        type=str,
        metavar="PATH",
    ...
    parser.add_argument(
        "--data_dir",
        default="C:/Users/padin/Desktop/Scoltech/BIOSIGNALS/ptb-xl-a-large-publicly-available-electrocardiography-dataset-1.0.3/ptb-xl-a-large-publicly-available-electrocardiography-dataset-1.0.3_test/",  # "/mount/ecg/cpsc_2018/"
        type=str,
...
def main(config):
    ...
    waves_train, waves_test, labels_train, labels_test = waves_from_config(
        config, reduced_lead=True
    )
    ...
    print('config["ckpt_dir"]', config["ckpt_dir"])
