...
def parse(args_list=None):
    ...
    parser.add_argument('--ckpt_dir',               default="/home/jupyter/datasphere/project/egor_data_feature_extraction/weights/ecg_jepa_20250725_031756_[0.175, 0.225]_feature_extraction/epoch10.pth",
                        type=str,
                        metavar='PATH',
