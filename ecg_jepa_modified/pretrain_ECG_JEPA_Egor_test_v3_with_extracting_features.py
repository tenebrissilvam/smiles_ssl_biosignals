...
parser.add_argument('--batch_size', type=int, default=8, help="Batch size")  ###Egor modify
parser.add_argument('--lr', type=float, default=5e-20, help="Learning rate")  ###Egor modify
parser.add_argument('--mask_type', type=str, default='block', help="Type of masking") # 'block' or 'random'
parser.add_argument('--epochs', type=int, default=100, help="Number of epochs")
parser.add_argument('--wd', type=float, default=5e-10, help="Weight decay") ###Egor modify
parser.add_argument('--data_dir_shao', type=str, default='C:/Users/padin/Desktop/Scoltech/BIOSIGNALS/a-large-scale-12-lead-electrocardiogram-database-for-arrhythmia-study-1.0.0/WFDBRecords_cut/', help="Directory for Shaoxing data")



parser.add_argument('--data_dir_code15', type=str, default='C:/Users/padin/Desktop/Scoltech/BIOSIGNALS/code15', help="Directory for Code15 data")
...
model = ecg_jepa(encoder_embed_dim=384, 
                 encoder_depth=6, 
                 encoder_num_heads=16,
